...
/**
 *  Crivo de Eratostenes - Recebe um vetor e um número
 *  para verificar quais posições do vetor tem o index primo ou não
 *
 * @param {[number]} vetorIndicativo - Vetor com {posicoes} posiçoes preenchidas
 *  inicalmente com 0 para retornar
