...
/**
 * Potencia - função para retornar o resultado de x^y usando somas
 * reutilizando a função produto do algorítimo 6
 *
...
function potencia(base, expoente) {
  ...
  for (let i = 1; i <= expoente; i += 1) {
    potenciaVar = Produto.produto(potenciaVar, base);
  }
  return potenciaVar;
}
