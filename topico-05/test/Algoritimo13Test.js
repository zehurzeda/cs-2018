...
describe('Algoritimo 13', () => {
  it('Raiz de 4 é igual a 2', () => {
    expect(Operacao.raiz(4, 10)).to.eql(2);
  });
});

describe('Algoritimo 13', () => {
  it('Raiz de 3, com precisão de 10 é igual a 1.7320508075688772', () => {
    expect(Operacao.raiz(3, 10)).to.eql(1.7320508075688772);
  });
});

describe('Algoritimo 13', () => {
  it('Raiz de 3, com precisão de 2 é igual a 1.7321428571428572', () => {
...
describe('Algoritimo 13', () => {
  it('Deve retornar erro quando i for inválido', () => {
    expect(() => {
      Operacao.raiz(3, 'v');
    }).to.throw(Error);
  });
...
describe('Algoritimo 13', () => {
  it('Deve retornar erro quando i for menor que 0', () => {
    expect(() => {
      Operacao.raiz(3, -1);
    }).to.throw(Error);
  });
